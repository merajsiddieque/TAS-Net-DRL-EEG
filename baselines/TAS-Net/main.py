...
if __name__ == '__main__':
    if args.training:
        ...
        # Create logs directory and initialize CSV
        os.makedirs('logs', exist_ok=True)
        csv_file_path = os.path.join('logs', f'training_log_subj{args.subject_id}_{args.reward_function}.csv')
        import csv
        ...
        for epoch in range(start_epoch, args.epochs):
            ...
            if (epoch + 1) % 1 == 0:
                ...
                with open(csv_file_path, mode='a', newline='') as f:
                    writer = csv.writer(f)
                    writer.writerow([epoch + 1, epoch_policy_loss, 0.0, 0.0, epoch_reward, Recall])
