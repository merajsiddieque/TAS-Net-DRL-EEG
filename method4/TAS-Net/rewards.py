...
def compute_reward(seq, actions, ignore_far_sim=False, temp_dist_thre=20, sparsity_weight=0.1):
    """
    Compute diversity reward, representativeness reward, and sparsity reward
    ...
    # Compute sparsity reward (penalize selecting a high ratio of frames)
    reward_sparsity = - (num_picks / n)
    ...
    if num_picks == 1:
        ...
        if ignore_far_sim:
            ...
            sim_submat_clone = sim_submat.clone()
            sim_submat_clone[temp_dist_mat > temp_dist_thre] = 1.
            sim_submat = sim_submat_clone
    ...
    reward = (reward_sim + reward_rep) * 0.5 + sparsity_weight * reward_sparsity
    return reward
